      ...
      <svg style="position: absolute; width: 0; height: 0; overflow: hidden;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
		...
		<div class="navbar">
			<div class="navbar-left-container">
				<a href='/'>
					<img class='navbar-brand-container' src="/static/logo.png">
				</a>
			</div>
					...
					<div class="confirm-tips">
						...
						<ul>
							<li class="regi_form_input">
								...
								<input type="text" class="regi_login_input regi_login_input_left" placeholder="User Name" data-type="loginname" v-model="userName">
							</li> 
							<li class="regi_form_input">
								<i class="icon IconPwd"></i>
								<input type="password" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="Password" v-model="userPwd" @keyup.enter="login">
							</li> 							
						</ul>
					</div>
